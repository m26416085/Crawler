...
class HomeController extends Controller
{
    ...
    public function find(Request $request)
    {
        ...
        if (isset($_POST['find'])) {
            ...
            $url = "https://ace.tokopedia.com/search/product/v3?scheme=https&device=desktop&related=true&catalog_rows=5&source=search&ob=23&st=product&rows=".$limit."&item=".$limit."&start=0&fcity=".$city_value[0]."&q=" .$search. "&pmin=".$pmin."&pmax=".$pmaks."&unique_id=a5e21c08aa434ccda179065dc7e41c73&safe_search=false";

...
>>>>>>> Stashed changes
                ...
                $data_arr['data'][] = array('id' => $search, 'image_url' => $tokped_link_img, 'product_name' => $tokped_link_productname, 'price_format' => $tokped_link_productprice, 'price' => $tokped_link_price, 'shop_name' => $tokped_link_shopname, 'shop_location' => $tokped_link_shoplocation, 'product_url' => $search, 'keyword' => $search);
                //tokopedia
                $counttokped=0;
                $countshopee=-1;
            }
